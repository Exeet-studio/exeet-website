...

       {
        ...
        items: [
...

          {
            ...
            description:
              '在電氣編制的襯托下，SherryZ 鄭雙雙以張力十足的嗓音，不僅展現對 R&B 轉音的駕馭，更以華語與英語交替演唱，唱出節奏分明、個性鮮明的都會女性韻味；鄭宜農則以爵士和弦鋪陳，結合溫潤細膩的臺語語感，詮釋內斂且深沉的情感層次。這首歌詮釋出兩種截然不同的女性氣質：一方憑直覺創作，展現靈魂樂的律動與當代 R&B 的前衛；另一方則以成人當代音樂的感性與哲思交織，描繪內在世界。 她們透過音樂對話，在差異中彼此傾聽，讓歌曲回歸創作的本源——「律動」與「身體感知」。對她們而言，寫歌不只是產出，更是推翻自我的過程，在音樂與生活中追尋自由，同時享受創作卡關的痛楚。 〈Right Here〉承載了這種不設限、不被定義的狀態，把創作最迷人、最痛苦的時刻都融入其中。',
